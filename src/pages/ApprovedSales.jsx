      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-4">
        <div className="w-full sm:w-auto">
          ...
          <p className="text-sm sm:text-base text-gray-600 mt-1">
            View all QC approved sales orders
          </p>
        </div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <p>
                      ...
                      {selectedSale.orderDate
                        ? new Date(selectedSale.orderDate).toLocaleString()
                        : "-"}
                    </p>
                    <p>
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">
                    {selectedSale.deliveryAddress.street && (
                      <p>{selectedSale.deliveryAddress.street}</p>
                    )}
                    {selectedSale.deliveryAddress.city && (
                      <p>{selectedSale.deliveryAddress.city}</p>
                    )}
                    {selectedSale.deliveryAddress.country && (
                      <p>{selectedSale.deliveryAddress.country}</p>
                    )}
                  </div>
                </div>
              )}
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {selectedSale.items.map((item, idx) => (
                      ...
                      >
                        ...
                        <p className="text-sm">
                          Quantity: {item.quantity} × Rs {item.unitPrice} = Rs{" "}
                  ...
                  <div className="mt-4 text-right">
                    <p className="text-lg font-bold">
                      Total: Rs{" "}
                      {selectedSale.totalAmount?.toLocaleString() || "0"}
                    </p>
                  </div>
                </div>
              )}
